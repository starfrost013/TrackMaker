...
{
    // Hmm
    public enum DanoUIComponent { StartPage, NewProject, NewSeason, ProjectMain, Export2, ApplicationSettings, AddNewStorm, AddTrackPoint, BasinSwitcher, CategoryManager, SeasonManager, PackInstaller, AnimationEditor }
